...
{
    internal class PedidoVendaItemRepository : IRepository<Dictionary<string, List<Item>>>
    {
        private readonly string? _connectionString;        
        private readonly BlingSingleProdutoFetcher _blingSingleProdutoFetcher;
        private readonly ProdutoRepository _produtoRepository;

        public PedidoVendaItemRepository(IConfiguration configuration, TokenManager tokenManager)
        {
